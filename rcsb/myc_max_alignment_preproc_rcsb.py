...
output_pdb_file = "myc_max_rcsb.pdb"
...
output_pdb = "myc_max_rcsb_rotated.pdb"
...
myc_max_rcsb_rotated = mda.Universe(output_pdb)
nv.show_mdanalysis(myc_max_rcsb_rotated)
